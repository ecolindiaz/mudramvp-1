            ...
            <div className="flex flex-1 overflow-hidden">
              ...
              <div className="flex-[1.35] flex flex-col border-r border-white/10">
                <div className="px-4 lg:px-6 py-6 space-y-6">
                      ...
                      <div className="flex flex-col gap-3 pt-3">
                        {platform && (
                          <div className="flex items-center gap-3">
                            ...
                            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-white/10 px-3 py-1.5 text-xs text-white">
                        ...
                        {postedAt && (
                          <div className="flex items-center gap-3">
                            ...
                            <span className="inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-white/10 px-3 py-1.5 text-xs text-white/80">
                            ...
                            {group.items.map((item, idx) => {
                              ...
                              if (isRepo) {
                                return (
                                  <div key={`${group.label}-${idx}`} className="flex items-center gap-2">
                                    <div className="h-8 px-3 rounded-full bg-white/5 text-white border-0 text-xs font-medium gap-1.5 flex items-center">
                              ...
                              if (isBranch) {
                                return (
                                  <div
                                    key={`${group.label}-${idx}`}
                                    className="h-8 px-3 gap-2 rounded-full bg-white/5 text-white border border-white/[0.04] text-xs font-medium flex items-center"
                                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center gap-3 flex-wrap">
                        ...
                        {opportunityData?.isPromotionalOpportunity && (
                          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border text-sm font-medium bg-orange-500/10 border-orange-500/30 text-orange-400"
                      ...
                      <div className="rounded-2xl border border-white/10 bg-black/30 overflow-hidden">
                        <div className="px-5 py-3 border-b border-white/10 flex items-center justify-between">
                          ...
                          {opportunityData?.isPromotionalOpportunity && (
                            <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-xs text-orange-400">
                  ...
                  <div className="rounded-2xl border border-white/[0.04] bg-[#1a1a1a] overflow-hidden shadow-sm flex flex-col h-[500px]">
                    ...
                    <div className="flex-1 overflow-y-auto p-6">
                      {taskStatus === "completed" ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-8">
                          <div className="relative w-full max-w-md bg-transparent backdrop-blur-sm rounded-2xl border border-red-500/20 p-6 shadow-xl overflow-hidden">
                            {/* Title Section */}
                        ...
                        <div className="flex flex-col items-center justify-center py-8">
                          <div className="relative w-full max-w-md bg-transparent backdrop-blur-sm rounded-2xl border border-white/[0.04] p-6 shadow-xl overflow-hidden">
                            {/* Title Section */}
                            <div className="text-center mb-5">
                              <h3 className="text-xl font-semibold text-white tracking-tight mb-2">
