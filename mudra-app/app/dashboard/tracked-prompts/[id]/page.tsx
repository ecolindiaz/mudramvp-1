                                  ...
                                  <div className="p-6 space-y-6">
                                    ...
                                    <div>
                                      ...
                                      <div className="flex flex-wrap gap-2">
                                        {(chat.responseCitations && chat.responseCitations.length > 0 ? chat.responseCitations : citationSources).map((c, idx) => (
                                          <Dialog key={`${(c as any).domain}-${(c as any).citationType ?? (c as any).type ?? ''}-${idx}`}>
                                            <DialogTrigger asChild>
