...
export { OverviewIcon, TrackedPromptsIcon, IssuesIcon, ContentLabIcon, AgentLabIcon }
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <InboxPanel open={inboxOpen} onOpenChange={setInboxOpen}>
                  ...
                  >
                    <Inbox strokeWidth={2.5} className="w-[25px] h-[25px] mr-1.25 transition-all duration-200 text-white/60 group-hover:text-white/80" />
