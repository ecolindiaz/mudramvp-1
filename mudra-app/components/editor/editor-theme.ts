export const editorTheme = {
  heading: {
    h1: "editor-h1 text-3xl font-bold mb-6 text-white mt-0",
    h2: "editor-h2 text-2xl font-semibold mb-4 text-white mt-8",
    h3: "editor-h3 text-xl font-medium mb-3 text-white mt-6",
    h4: "editor-h4 text-lg font-medium mb-2 text-white mt-4",
  },
  paragraph: "editor-p",
  text: {
    bold: "font-semibold text-white",
    italic: "italic text-white/90",
    underline: "underline text-white/90",
    strikethrough: "line-through text-white/70",
    code: "bg-white/10 px-2 py-1 rounded text-sm text-white/90 font-mono",
  },
  list: {
    ul: "editor-ul list-disc ml-6 mb-4 text-white/90 space-y-2",
    ol: "editor-ol list-decimal ml-6 mb-4 text-white/90 space-y-2",
    listitem: "editor-li text-white/90 leading-relaxed",
  },
