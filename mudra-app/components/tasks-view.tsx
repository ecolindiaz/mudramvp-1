  ...
  return (
    <div className="@container/main flex flex-1 flex-col gap-2 bg-dark-grey">
      <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
        {/* Header Cards */}
        <div className="*:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 lg:px-6 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs @xl/main:grid-cols-3">
          <MetricCard
            title="Total Tasks"
            value={tasks.length}
            status="Active"
