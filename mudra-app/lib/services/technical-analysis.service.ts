    ...
    try {
      ...
      await tx.structuredData.create({
        data: {
          ...
          jsonLdData: JSON.stringify(scraperResults.structuredData.jsonLd),
          microdataData: JSON.stringify(scraperResults.structuredData.microdata),
          rdfaData: JSON.stringify(scraperResults.structuredData.rdfa),
          schemaTypes: JSON.stringify(scraperResults.structuredData.schemaTypes),
          faqSchemas: JSON.stringify(scraperResults.structuredData.faqSchemas),
          organizationSchema: scraperResults.structuredData.organizationSchema ? JSON.stringify(scraperResults.structuredData.organizationSchema) : null,
          websiteSchema: scraperResults.structuredData.websiteSchema ? JSON.stringify(scraperResults.structuredData.websiteSchema) : null,
          breadcrumbSchema: scraperResults.structuredData.breadcrumbSchema ? JSON.stringify(scraperResults.structuredData.breadcrumbSchema) : null,
      ...
      await tx.entityRecognition.create({
        data: {
          technicalAnalysisId: analysis.id,
          organizations: JSON.stringify(scraperResults.entityRecognition.organizations),
          people: JSON.stringify(scraperResults.entityRecognition.people),
          technologies: JSON.stringify(scraperResults.entityRecognition.technologies),
          products: JSON.stringify(scraperResults.entityRecognition.products),
          locations: JSON.stringify(scraperResults.entityRecognition.locations),
      ...
      await tx.fAQAnalysis.create({
        data: {
          ...
          faqSections: JSON.stringify(scraperResults.faqOptimization.faqSections),
      ...
      await tx.contentFreshness.create({
        data: {
          ...
          freshnessSignals: JSON.stringify(scraperResults.contentFreshness.freshnessSignals),
      ...
      await tx.contentStructure.create({
        data: {
          technicalAnalysisId: analysis.id,
          headingsHierarchy: JSON.stringify(scraperResults.contentStructure.headingsHierarchy),
          ...
          authoritySignals: JSON.stringify(scraperResults.contentStructure.authoritySignals),
      ...
      await tx.technicalAccessibility.create({
        data: {
          technicalAnalysisId: analysis.id,
          metaTags: JSON.stringify(scraperResults.technicalAccessibility.metaTags),
          ...
          openGraphData: JSON.stringify(scraperResults.technicalAccessibility.metaTags?.openGraph || {}),
          twitterCardData: JSON.stringify(scraperResults.technicalAccessibility.metaTags?.twitterCard || {}),
          ...
          technicalElements: JSON.stringify(scraperResults.technicalAccessibility.technicalElements),
          ...
          accessibilityData: JSON.stringify(scraperResults.technicalAccessibility.accessibility),
